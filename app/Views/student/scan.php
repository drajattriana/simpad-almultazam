        ...
        <div class="card-body">
          <div class="row justify-content-center">
            <div class="col-12 col-md-8 col-lg-6">
              ...
              <div class="mt-3">
                <!-- <label class="form-label">Data Form (method)</label> -->
                <div class="input-group">
                  <input type="hidden" id="methodInput" name="method" class="form-control" placeholder="Isikan data method (opsional)" value="<?= $scan ?>">
                </div>
              </div>
            </div>
          </div>
