                                    ...
                                    <?php foreach ($menus as $menu) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="<?= site_url('superadmin/submenu/'.$id_menu.'/delete/' . $menu['id']) ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda yakin ingin menghapus role ini?')">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="<?= base_url('superadmin/submenu/'.$id_menu.'/add') ?>" method="POST">
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3 mb-3">
                                    <div class="form-group form-group-default">
                                        ...
                                        <input id="text" type="text" class="form-control" placeholder="url <?= $title ?>" name="url" required style="padding-left: 10px;">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12 mb-3 mb-3">
                                    <div class="form-group form-group-default">
                                        ...
                                        <input id="text" type="text" class="form-control" placeholder="icon <?= $title ?>" name="icon" required style="padding-left: 10px;">
                                    </div>
                                </div>

                                <input id="text" type="hidden" class="form-control" placeholder="icon <?= $title ?>" name="menu" value="<?=  $data_menu['name'] ?>" required style="padding-left: 10px;">                                
                                <input id="text" type="hidden" class="form-control" placeholder="icon <?= $title ?>" name="id_menu" value="<?=  $id_menu ?>" required style="padding-left: 10px;">
                            </div>
                    </div>
        ...
        <div class="modal fade" id="editRowModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="<?= base_url('superadmin/submenu/'.$id_menu.'/update') ?>" method="POST">
...
<script>
  $(function () {
    ...
    $('#editRowModal').on('show.bs.modal', function(e) {
        ...
        $.ajax({
            type: 'post',
            url: '<?= base_url('Ajax/edit_submenu/') ?>' + id,
            data: {
                'id': id,
